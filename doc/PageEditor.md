...
- Route implementation loads the page JSON from disk and renders via a generated `AggoElementRenderer`.
...
Handler signature recommendation:
...
The runtime resolves `rfq.view.onSubmit` to an actual function via a generated or user-maintained registry (see doc/Component.md and doc/PageDebugger.md).
